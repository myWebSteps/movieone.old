...
<!--                <div class="cover-pic">-->
<!--&lt;!&ndash;                    <div class="position-absolute bg-white shadow-sm rounded text-center p-2 m-4 love-box">&ndash;&gt;-->
<!--&lt;!&ndash;                        <h6 class="text-gray-900 mb-0 font-weight-bold"><i class="fas fa-heart text-danger"></i> 50%</h6>&ndash;&gt;-->
<!--&lt;!&ndash;                        <small class="text-muted">8,784</small>&ndash;&gt;-->
<!--&lt;!&ndash;                    </div>&ndash;&gt;-->
<!--&lt;!&ndash;                     Постер Рекламы&ndash;&gt;-->
